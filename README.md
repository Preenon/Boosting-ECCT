...
⋅⋅⋅⋅* boosted_ECCT_boosting_notebook.ipynb: Loads trained models, applies selected boosting methodologies, and performs BER evaluations.
⋅⋅⋅⋅*results/: Contains sample boosted models and BER plots from the paper.
